...
<!--***DAN: The assignment requested that you identify in comments in your Rmd in which ways you have used the concepts of modularity that we learned, but you have not done that.-->
...
<!--***DAN: The data are used on lines 24 and 25, but they have not been loaded yet (from disk or elsewhere)
so this will not work by itself. IF the data were loaded it looks like it would work OK. You just need
a chunk prior to this one to load the data.-->

<!--***DAN: you generally do not want your code to appear in a scientific paper, so in this case you should use echo=F in the chunk header-->
...
<!--***DAN:You do not need to repeat lines 45 and 46, if you had them from the earlier chunk they are still there.-->
...
<!--***DAN:You seem to understand how to filter subsets meeting certain conditions out of data frames, and 
that's good-->
...
<!--***DAN: you should delete the below remnant of the original file, you do not need it-->
